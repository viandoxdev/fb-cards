(async ()=>{
    var X = "" + new URL("assets/fb_web_bg-H7ebekk_.wasm", import.meta.url).href, K = async (t = {}, _)=>{
        let e;
    ...
    class l {
        ...
        constructor(_, e, s, o, i, c){
            ...
            const O = f(e, r.__wbindgen_export, r.__wbindgen_export2), j = d, L = f(s, r.__wbindgen_export, r.__wbindgen_export2), P = d, V = f(o, r.__wbindgen_export, r.__wbindgen_export2), G = d, N = f(i, r.__wbindgen_export, r.__wbindgen_export2), H = d, J = D(c, r.__wbindgen_export), Y = d, $ = r.card_new(g, u, O, j, L, P, V, G, N, H, J, Y);
            return this.__wbg_ptr = $ >>> 0, E.register(this, this.__wbg_ptr, this), this;
        }
    }
    ...
    class z {
        static __wrap(_) {
            ...
            return e.__wbg_ptr = _, F.register(e, e.__wbg_ptr, e), e;
        }
        __destroy_into_raw() {
            const _ = this.__wbg_ptr;
    ...
    class k {
        ...
        prepare_source(_, e) {
            try {
                const c = r.__wbindgen_add_to_stack_pointer(-16), g = D(_, r.__wbindgen_export), u = d;
                w_(e, R);
    ...
    const E = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((t)=>r.__wbg_card_free(t >>> 0, 1)), F = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    ...
    const n = await K({
        "./fb_web_bg.js": {
            __wbg_Error_83742b46f01ce22d: Q,
            ...
            __wbg___wbindgen_string_get_395e606bd0ee4427: Z,
    ...
    }, X), y_ = n.memory, x_ = n.__wbg_core_free, z_ = n.core_compile, v_ = n.core_new, q_ = n.core_prepare_source, I_ = n.start, A_ = n.__wbg_cardpage_free, R_ = n.cardpage_svg, C_ = n.__wbg_get_sourceconfig_page_width, S_ = n.__wbg_get_sourceconfig_sans_math, k_ = n.__wbg_get_sourceconfig_text_color, E_ = n.__wbg_get_sourceconfig_text_size, F_ = n.__wbg_set_sourceconfig_page_width, T_ = n.__wbg_set_sourceconfig_sans_math, U_ = n.__wbg_set_sourceconfig_text_color, W_ = n.__wbg_set_sourceconfig_text_size, D_ = n.__wbg_sourceconfig_free, M_ = n.sourceconfig_new, B_ = n.__wbg_card_free, O_ = n.card_new, j_ = n.qcms_transform_data_rgb_out_lut, L_ = n.qcms_transform_data_rgba_out_lut, P_ = n.qcms_transform_data_bgra_out_lut, V_ = n.qcms_transform_data_rgb_out_lut_precache, G_ = n.qcms_transform_data_rgba_out_lut_precache, N_ = n.qcms_transform_data_bgra_out_lut_precache, H_ = n.qcms_profile_precache_output_transform, J_ = n.qcms_transform_release, Y_ = n.qcms_profile_is_bogus, $_ = n.qcms_white_point_sRGB, X_ = n.lut_inverse_interp16, K_ = n.lut_interp_linear16, Q_ = n.rust_zstd_wasm_shim_calloc, Z_ = n.rust_zstd_wasm_shim_free, _t = n.rust_zstd_wasm_shim_malloc, tt = n.rust_zstd_wasm_shim_memcmp, et = n.rust_zstd_wasm_shim_memcpy, rt = n.rust_zstd_wasm_shim_memmove, nt = n.rust_zstd_wasm_shim_memset, st = n.rust_zstd_wasm_shim_qsort, ot = n.qcms_enable_iccv4, ct = n.__wbindgen_export, it = n.__wbindgen_export2, at = n.__wbindgen_export3, gt = n.__wbindgen_add_to_stack_pointer, M = n.__wbindgen_start;
    var dt = Object.freeze({
        ...
        __wbg_get_sourceconfig_text_color: k_,
        __wbg_get_sourceconfig_text_size: E_,
        __wbg_set_sourceconfig_page_width: F_,
        __wbg_set_sourceconfig_sans_math: T_,
        __wbg_set_sourceconfig_text_color: U_,
        __wbg_set_sourceconfig_text_size: W_,
        __wbg_sourceconfig_free: D_,
        ...
        lut_interp_linear16: K_,
        lut_inverse_interp16: X_,
        memory: y_,
        qcms_enable_iccv4: ot,
        qcms_profile_is_bogus: Y_,
        qcms_profile_precache_output_transform: H_,
        qcms_transform_data_bgra_out_lut: P_,
        qcms_transform_data_bgra_out_lut_precache: N_,
        qcms_transform_data_rgb_out_lut: j_,
        qcms_transform_data_rgb_out_lut_precache: V_,
        qcms_transform_data_rgba_out_lut: L_,
        qcms_transform_data_rgba_out_lut_precache: G_,
        qcms_transform_release: J_,
        qcms_white_point_sRGB: $_,
        rust_zstd_wasm_shim_calloc: Q_,
        rust_zstd_wasm_shim_free: Z_,
    ...
    self.onmessage = async (t)=>{
        ...
        if (_.type === "INIT") {
            ...
            S = new k(new Uint8Array(s)), console.log("Core initialized."), B();
            return;
        }
