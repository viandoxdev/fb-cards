(async ()=>{
    var N = "" + new URL("assets/fb_web_bg-CW_WeNIM.wasm", import.meta.url).href, $ = async (e = {}, _)=>{
        let t;
    ...
    var ie = Object.freeze({
        ...
        qcms_transform_data_bgra_out_lut_precache: $_,
