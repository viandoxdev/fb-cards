(async ()=>{
    var J = "" + new URL("assets/fb_web_bg-CW_WeNIM.wasm", import.meta.url).href, Y = async (e = {}, _)=>{
        let t;
    ...
    class d {
        static __unwrap(_) {
            return _ instanceof d ? _.__destroy_into_raw() : 0;
        }
        __destroy_into_raw() {
        ...
        constructor(_, t, s, o, a, c){
            var g = T(_) ? 0 : l(_, r.__wbindgen_malloc, r.__wbindgen_realloc), f = i;
            const U = l(t, r.__wbindgen_malloc, r.__wbindgen_realloc), D = i, B = l(s, r.__wbindgen_malloc, r.__wbindgen_realloc), L = i, O = l(o, r.__wbindgen_malloc, r.__wbindgen_realloc), k = i, P = l(a, r.__wbindgen_malloc, r.__wbindgen_realloc), V = i, j = W(c, r.__wbindgen_malloc), N = i, G = r.card_new(g, f, U, D, B, L, O, k, P, V, j, N);
            return this.__wbg_ptr = G >>> 0, R.register(this, this.__wbg_ptr, this), this;
        }
    }
    ...
    class p {
        static __wrap(_) {
            ...
            return t.__wbg_ptr = _, S.register(t, t.__wbg_ptr, t), t;
        }
        __destroy_into_raw() {
            const _ = this.__wbg_ptr;
    ...
    class C {
        ...
        compile() {
            ...
            if (_[3]) throw q(_[2]);
            var t = f_(_[0], _[1]).slice();
            return r.__wbindgen_free(_[0], _[1] * 4, 4), t;
        }
        constructor(_){
            const t = l_(_, r.__wbindgen_malloc), s = i, o = r.core_new(t, s);
            if (o[2]) throw q(o[1]);
    ...
    function X(e, _) {
        ...
        var o = T(s) ? 0 : l(s, r.__wbindgen_malloc, r.__wbindgen_realloc), a = i;
    ...
    function s_(e, _) {
        const t = _.stack, s = l(t, r.__wbindgen_malloc, r.__wbindgen_realloc), o = i;
    ...
    const R = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    } : new FinalizationRegistry((e)=>r.__wbg_card_free(e >>> 0, 1)), S = typeof FinalizationRegistry > "u" ? {
        register: ()=>{},
        unregister: ()=>{}
    ...
    function l_(e, _) {
        ...
        return b().set(e, t / 1), i = e.length, t;
    }
    function W(e, _) {
    ...
    function l(e, _, t) {
        if (t === void 0) {
            ...
            return b().subarray(f, f + g.length).set(g), i = g.length, f;
        }
        ...
        if (c !== s) {
            ...
            const g = b().subarray(o + c, o + s), f = m.encodeInto(e, g);
    ...
    function d_(e, _) {
        return v += _, v >= w_ && (x = new TextDecoder("utf-8", {
            ignoreBOM: !0,
            fatal: !0
        }), x.decode(), v = _), x.decode(b().subarray(e, e + _));
    }
    ...
    const n = await Y({
        "./fb_web_bg.js": {
            __wbg_card_unwrap: K,
            __wbg_log_524eedafa26daa59: r_,
            __wbg_info_7d4e223bb1a7e671: t_,
            __wbg_warn_69424c2d92a2fa73: o_,
            __wbg_debug_4b9b1a2d5972be57: Z,
            __wbg_error_8d9a8e04cd1d3588: __,
            __wbg_new_227d7c05414eb861: n_,
            __wbg_stack_3b0d974bbf31e44f: s_,
            __wbg_error_a6fa202b58aa1cd3: e_,
            __wbg_cardpage_new: Q,
            __wbg___wbindgen_string_get_395e606bd0ee4427: X,
            __wbg___wbindgen_throw_6ddd609b62940d55: H,
            __wbg_Error_83742b46f01ce22d: $,
            __wbindgen_init_externref_table: a_,
            __wbindgen_cast_0000000000000001: c_
        }
    }, J), b_ = n.memory, m_ = n.__wbg_core_free, p_ = n.core_compile, h_ = n.core_new, y_ = n.core_prepare_source, x_ = n.start, z_ = n.__wbg_card_free, q_ = n.card_new, v_ = n.rust_zstd_wasm_shim_calloc, A_ = n.rust_zstd_wasm_shim_free, C_ = n.rust_zstd_wasm_shim_malloc, R_ = n.rust_zstd_wasm_shim_memcmp, S_ = n.rust_zstd_wasm_shim_memcpy, E_ = n.rust_zstd_wasm_shim_memmove, F_ = n.rust_zstd_wasm_shim_memset, T_ = n.rust_zstd_wasm_shim_qsort, W_ = n.__wbg_cardpage_free, I_ = n.cardpage_svg, M_ = n.__wbg_get_sourceconfig_page_width, U_ = n.__wbg_get_sourceconfig_sans_math, D_ = n.__wbg_get_sourceconfig_text_color, B_ = n.__wbg_get_sourceconfig_text_size, L_ = n.__wbg_set_sourceconfig_page_width, O_ = n.__wbg_set_sourceconfig_sans_math, k_ = n.__wbg_set_sourceconfig_text_color, P_ = n.__wbg_set_sourceconfig_text_size, V_ = n.__wbg_sourceconfig_free, j_ = n.sourceconfig_new, N_ = n.qcms_enable_iccv4, G_ = n.qcms_profile_precache_output_transform, J_ = n.qcms_transform_data_bgra_out_lut, Y_ = n.qcms_transform_data_bgra_out_lut_precache, $_ = n.qcms_transform_data_rgb_out_lut, X_ = n.qcms_transform_data_rgb_out_lut_precache, H_ = n.qcms_transform_data_rgba_out_lut, K_ = n.qcms_transform_data_rgba_out_lut_precache, Q_ = n.qcms_transform_release, Z_ = n.qcms_profile_is_bogus, _e = n.qcms_white_point_sRGB, ee = n.lut_inverse_interp16, te = n.lut_interp_linear16, re = n.__wbindgen_malloc, ne = n.__wbindgen_realloc, se = n.__wbindgen_free, oe = n.__wbindgen_externrefs, ce = n.__externref_table_alloc, ae = n.__externref_table_dealloc, ie = n.__externref_drop_slice, I = n.__wbindgen_start;
    var ge = Object.freeze({
        __proto__: null,
        __externref_drop_slice: ie,
        __externref_table_alloc: ce,
        __externref_table_dealloc: ae,
        __wbg_card_free: z_,
        __wbg_cardpage_free: W_,
        __wbg_core_free: m_,
        __wbg_get_sourceconfig_page_width: M_,
        __wbg_get_sourceconfig_sans_math: U_,
        __wbg_get_sourceconfig_text_color: D_,
        __wbg_get_sourceconfig_text_size: B_,
        __wbg_set_sourceconfig_page_width: L_,
        __wbg_set_sourceconfig_sans_math: O_,
        __wbg_set_sourceconfig_text_color: k_,
        __wbg_set_sourceconfig_text_size: P_,
        ...
        core_compile: p_,
        core_new: h_,
        core_prepare_source: y_,
        lut_interp_linear16: te,
        lut_inverse_interp16: ee,
        memory: b_,
        qcms_enable_iccv4: N_,
        qcms_profile_is_bogus: Z_,
        qcms_profile_precache_output_transform: G_,
        qcms_transform_data_bgra_out_lut: J_,
        qcms_transform_data_bgra_out_lut_precache: Y_,
        qcms_transform_data_rgb_out_lut: $_,
        qcms_transform_data_rgb_out_lut_precache: X_,
        qcms_transform_data_rgba_out_lut: H_,
        qcms_transform_data_rgba_out_lut_precache: K_,
        qcms_transform_release: Q_,
        qcms_white_point_sRGB: _e,
        rust_zstd_wasm_shim_calloc: v_,
        rust_zstd_wasm_shim_free: A_,
        rust_zstd_wasm_shim_malloc: C_,
        rust_zstd_wasm_shim_memcmp: R_,
        rust_zstd_wasm_shim_memcpy: S_,
        rust_zstd_wasm_shim_memmove: E_,
        rust_zstd_wasm_shim_memset: F_,
        rust_zstd_wasm_shim_qsort: T_,
        sourceconfig_new: j_,
        start: x_
    });
    u_(ge);
    ...
    self.onmessage = async (e)=>{
        ...
        if (_.type === "INIT") {
            ...
            A = new C(new Uint8Array(s)), console.log("Core initialized."), M();
            return;
        }
        if (await fe, _.type === "COMPILE_CARD") {
            const t = _.payload.card;
            A.prepare_source([
                new d(t.header, t.id, t.name, t.question, t.answer, t.locations)
